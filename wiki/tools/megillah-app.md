...
synchronized Megillah-reading app built in ~10 days for Purim 2026 by
[[../people/mendy-elishevitz]] with live community feature requests.
...
- **Shake to grogger** option (Berel Marozov's suggestion).
...
1. Mendy ships v0 (basic synchronized reading).
2. Posts to AIFS Builders WhatsApp group.
3. Community sends feature requests (translations, transliteration,
   broadcast latency, kids mode, sound effects).
4. Mendy merges or pushes back within hours.
5. Repeat for ~10 days, culminating in Purim 2026.

Berel Marozov, Rayi Stern, +44 7557 981531, Mendel Super, Mendy Mann,
+44 7980-795936, and many others contributed feature ideas / pull
requests during the sprint. Treated by the community as proof that
...
- **Browser security blocks features.** Voice recognition for
  ...
  time delay."* [chat 2026-02-22, Mendy Elishevitz]. Same for OS-level
