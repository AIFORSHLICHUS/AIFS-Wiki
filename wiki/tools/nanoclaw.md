...
Integrated with Docker"* — shared [chat 2026-03-13].

## What the chat uses it for

- **CRM agents that work safely.** Pattern with [[../tools/crm-tools]]
  (LGL). *"It's available free through Nanoclaw. Highly recommend
  learning more before getting another service."* [chat 2026-05-15]
...
[chat 2026-03-13]: *"ClawdBot changed the world but
...
- Sandboxed execution.
- Self-learning across CRM features (reported by users).
