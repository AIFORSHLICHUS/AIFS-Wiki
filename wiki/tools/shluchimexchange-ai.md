...
Hashluchim 2025-11-13 by community members. Hosts curated
...
- `haggadah.shluchimexchange.ai` — customizable printable Haggadahs
  (children's and adults'). [chat 2026-03-22]
...
- **Flyer generation agent** — generates prompts for image models, not
  images directly (as of [chat 2026-02-11]).
...
- **Beta-test new agents** in private; iterate based on community feedback.
