...
- **Claude** — best at *Yiddish*, which is hard for everyone (Yiddish OCR
  &gt; Hebrew OCR in difficulty). [chat 2026-04-21, Yossi Yaffe] ran a bake-off
...
translation. Yossi Yaffe: "sofer.ai" recommended specifically for
...
| Ashkenazi Hebrew pronunciation | n/a | Trick: write the text in Hebrew with *nikkud* tuned for Ashkenazi sounds; ElevenLabs V3 then pronounces correctly. [chat 2025-11-21, Rayi Stern + Elisha Pearl] |
...
- **Hebrew print (square letters).** Decent options exist:
  - **Google DocumentAI** ($300 free credit on Google Cloud).
    [chat 2025-09-11, Yonatan Azrielant]
...
- **Likkutei Sichos PDF (two-column, footnotes mixed in).**
  ...
  text export, then translate. [chat 2025-11-04, Mendy Shishler]
